...
HD_PWD='/home/m1/texierl/Documents/AEO/TP5_preparation/TP5_preparation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afficher_16bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afficher_16bits.tcl
