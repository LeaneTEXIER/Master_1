...
HD_PWD='/home/m1/texierl/Documents/AEO/TP5_preparation/TP5_preparation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log afficher_16bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source afficher_16bits.tcl -notrace
