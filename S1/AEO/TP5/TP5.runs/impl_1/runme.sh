...
HD_PWD='/home/m1/texierl/Documents/AEO/TP5/TP5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digicode_chenillard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digicode_chenillard.tcl -notrace
