...
HD_PWD='/home/m1/texierl/Documents/AEO/TP5/TP5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digicode_chenillard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digicode_chenillard.tcl
