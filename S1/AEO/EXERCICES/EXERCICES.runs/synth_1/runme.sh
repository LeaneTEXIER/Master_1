...
HD_PWD='/home/m1/texierl/Documents/AEO/EXERCICES/EXERCICES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tp3_exo1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tp3_exo1.tcl
