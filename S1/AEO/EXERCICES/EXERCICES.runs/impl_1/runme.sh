...
HD_PWD='/home/m1/texierl/Documents/AEO/EXERCICES/EXERCICES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tp3_exo1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tp3_exo1.tcl -notrace
